...
class _PolicyGradient():
    ...
    def __init__(self,env,nn:NN_model,state_size,min_score_aceptable,hold_results=False) -> None:
        """
    ...
    def action_and_grads(self,state,nn:NN_model,loss_fn:keras.losses,method='roulette_prob')-> Tuple[int, List]:
        """
...
if __name__=="__main__":
    _PolicyGradient(1,NN_model(1),3,4,5)
    print('Tested')
